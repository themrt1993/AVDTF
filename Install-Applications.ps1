...
#region Foxit Reader
try {
    Start-Process -filepath msiexec.exe -Wait -ErrorAction Stop -ArgumentList '/i', 'c:\temp\FoxitPDFEditor121.msi', '/quiet', 'ADDLOCAL="FX_PDFVIEWER"'
...
#region Notepad++
try {
    Start-Process -filepath 'c:\temp\npp.8.4.7.exe' -Wait -ErrorAction Stop -ArgumentList '/S'
